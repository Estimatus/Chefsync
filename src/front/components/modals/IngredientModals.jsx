            ...
            <div className="modal-content small" onClick={e => e.stopPropagation()}>
                ...
                <div style={{display: 'flex', gap: '10px', justifyContent: 'flex-end'}}>
                    {ingredientSource === 'recipe' ? (
                        <><button onClick={onClose} className="btn-secondary">Cerrar</button><button onClick={onSave} className="btn-primary">Crear y agregar otro</button></>
                    ) : (
                        <><button onClick={onClose} className="btn-secondary">Cancelar</button><button onClick={onSave} className="btn-primary">Crear</button></>
                    )}
                </div>
            </div>
        </div>
