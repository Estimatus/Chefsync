                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    ...
                    <tbody>
                        {orders.length === 0 ? (
                            ...
                            return (
                                <tr key={order.id} style={{ borderBottom: i < orders.length - 1 ? "1px solid var(--border)" : "none", transition: "background 0.12s" }}
                                    onMouseEnter={e => e.currentTarget.style.background = "var(--bg3)"}
                                    onMouseLeave={e => e.currentTarget.style.background = "transparent"}
                                >
                                    <td style={{ padding: "12px 16px", fontSize: "13px", fontFamily: "var(--font-head)", fontWeight: 700, color: "var(--muted)" }}>
                                        #{order.id}
                                    </td>
